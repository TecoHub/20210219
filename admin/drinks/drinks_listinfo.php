...
if(isset($_POST['mode']))
{
	...
	if( $resval!= false){
	 ...
	 $InputArray['glass_CID'] =  $_POST['glass_CID'];
        $InputArray['glass_CID2'] =  $_POST['glass_CID2'];
		$InputArray['glass_price'] =  $_POST['glass_price'];
...
//no change
		...
		{	
            ...
            $InputArray['stock'] =  $_POST['stock'];
            $InputArray['drinkinfo'] =  $_POST['drinkinfo'];
								$InputArray['menus'] =  $_POST['menus'];
								//$InputArray['drink_type'] = "Bottle";

								$InputArray['groups'] =$_POST['CD1']."-".$_POST['CD2'];
...
//$InputArray['CD1'] =  $_POST['CD1g'];
         //   $InputArray['CD2'] =  $_POST['CD2g'];
											//$InputArray['drink_type'] = "Glass";

			           // $InputArray['price'] =  $_POST['priceg'];
