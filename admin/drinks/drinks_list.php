...
<tr><th>Bottle</th><th></th><th>Glass</th></tr>
		<tr>
			...
			<td>CD1</td> 
			<td><input type="text" name="CD1g" id="CD1g" size="20" value="<?php echo$dataarr[0]['CD1'] ?>" required></td>
		
		</tr>

		<tr>
		<td>CD2</td>
		<td><input type="text" name="glass_CID" id="glass_CID" size="20" value="<?php echo$dataarr[0]['glass_CID'] ?>" required></td>
		<td>CD2</td>
...
<option value="" <?php if($dataarr[0]['position']==""){echo"selected";} ?>> choose</option>
