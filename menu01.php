...
$bl=$dataarr[$t]['CID']."-".$dataarr[$t]['CID2']."-".$dataarr[$t]['price'];
...
<div id="addBookDialog<?php echo $dataarr[$t]['d_refid'];?>" class="modal fade" role="dialog" >
  <div class="modal-dialog">
    ...
    <div class="modal-content">
	  ...
	  <input type="text" hidden value="<?php echo $bl;?>" name="bottle">
	  	  <input type="text" hidden value="<?php echo $gl;?>" name="bottle">

      <div class="modal-body">
<img style='width: 200px; height:auto;' src='admin/drinks/upload/<?php echo $dataarr[$t]['productimage'];?>'>
<br>
...
<div class="form-group">
          ...
          <div class="input-group">
            <select name="price" id="prc<?php echo $dataarr[$t]['d_refid'];?>" onchange="calval(<?php echo $dataarr[$t]['d_refid'];?>)" data-placeholder="Select a grade..." class="form-control chosen-select" style="width:350px;" tabindex="2">
              <option value="<?php echo $dataarr[$t]['price'];?>">
                Bottle
              </option>
              <option value="<?php echo $dataarr[$t]['glass_price'];?>">
                Glass
              </option>
              </select>
...
<div class="form-group">
          ...
          <div class="input-group">
            <select name="qty" onchange="calval(<?php echo $dataarr[$t]['d_refid'];?>)" id="qty<?php echo $dataarr[$t]['d_refid'];?>" data-placeholder="Select a grade..." class="form-control chosen-select" style="width:350px;" tabindex="2">
              <option value="1">
                1
              </option>
              <option value="2">
	  ...
	  <div class="form-group">
	            <div class="input-group">
				<h1>
<input type="text"  value="0hgjhgjgjg" id="price<?php echo $dataarr[$t]['d_refid'];?>" readonly>
</h1>
	 </div> </div>
	  ...
	  <div class="form-group">
	            <div class="input-group">
				<h1>
<input type="submit"  value="submit" id="sub<?php echo $dataarr[$t]['d_refid'];?>" >
</h1>
	 </div> </div>
